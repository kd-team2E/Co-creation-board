...
<body>
    ...
    <input type = "button" class="btn btn-warning" onclick = "location.href = 'create_post.php'" value = "投稿">
    <input type = "button" class="btn btn-warning" onclick = "location.href = 'project_create.php'" value = "内容修正">
</body>
</html>